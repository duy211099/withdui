...
export default function Category({ category, tag, posts, all_categories, all_tags }: CategoryProps) {
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {filterType === 'category' && all_categories && all_categories.length > 1 && (
          <div className="mb-6 flex gap-2 flex-wrap">
            <span className="text-sm text-muted-foreground self-center mr-2">Other categories:</span>
